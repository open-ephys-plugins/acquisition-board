...
Next, launch Visual Studio and open the `OE_PLUGIN_acquisition-board.sln` file that was just created. Select the appropriate configuration (Debug/Release) and build the solution.
