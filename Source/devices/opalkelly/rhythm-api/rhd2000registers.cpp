...
double Rhd2000Registers::setLowerBandwidthDacValues(int dac1, int dac2, int dac3)
{
    if (dac1 < 0) {
        rLDac1 = 0;
    } else if (dac1 > 127) {
...
double Rhd2000Registers::setLowerBandwidthActual(double lowerBandwidth)
{
    const double RLBase = 3500.0;
    const double RLDac1Unit = 175.0;
    const double RLDac2Unit = 12700.0;
...
void Rhd2000Registers::getLowerBandwidthDacValues(int& dac1, int& dac2, int& dac3) const
{
    dac1 = rLDac1;
    dac2 = rLDac2;
    dac3 = rLDac3;
...
double Rhd2000Registers::getLowerBandwidth() const
{
    const double RLBase = 3500.0;
    const double RLDac1Unit = 175.0;
    const double RLDac2Unit = 12700.0;
